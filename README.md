...
- **[rag-eval](rag-eval/)** - measures RAG retrieval quality (recall@k, MRR, nDCG) from a labeled set and tells you whether retrieval, ranking, or generation is the bottleneck. Stop guessing which layer to fix.
